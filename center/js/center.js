...
function appendDesignTable(coordinates) {
  ...
  var appendRow = "<tr class='odd gradeX' id='misstr_" + tableCount + "'><td>" + tableCount + "</td><td>"
      ...
      + "<tr><td class='center'><input name='altdata' id='altdata_" + tableCount + "' type='text' class='form-control' value='3'></td><td class='center'>"
      + "<select class='form-control' id='actiondata_" + tableCount + "'>"
          + "<option selected value=1>액션1</option>"
          + "<option value=2>액션2</option>"
          + "<option value=3>액션3</option>"
          + "<option value=4>액션4</option>"
          + "<option value=5>액션5</option></select>"
      + "</td></tr></table>"
  + "</td></tr>"
